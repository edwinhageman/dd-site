...
class CourseTests {
    ...
    void setUp() {
        ...
        course = TestCourseBuilder.aCourse(event, dish, wine)
    ...
    class ConstructorTests {
        ...
        void shouldThrowExceptionWhenEventIsNull() {
            assertThrows(NullPointerException.class,
                    () -> new Course(null, testCourseNo, testCook, dish, wine));
        }
        ...
        void shouldThrowExceptionWhenCourseNoIsNull() {
            assertThrows(NullPointerException.class,
                    () -> new Course(event, null, testCook, dish, wine));
        }
        ...
        void shouldThrowExceptionWhenCookIsNull() {
            assertThrows(NullPointerException.class,
                    () -> new Course(event, testCourseNo, null, dish, wine));
        }
        ...
        void shouldThrowExceptionWhenDishIsNull() {
            assertThrows(NullPointerException.class,
                    () -> new Course(event, testCourseNo, testCook, null, wine));
        }
        ...
        void shouldThrowExceptionWhenWineIsNull() {
            assertThrows(NullPointerException.class,
                    () -> new Course(event, testCourseNo, testCook, dish, null));
        }
    }
