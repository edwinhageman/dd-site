...
@DisplayName("GrapeUpsertRequest validation tests")
class GrapeUpsertRequestValidatorTest {

	private Validator validator;

	private final GrapeUpsertRequest validRequest = new GrapeUpsertRequest("name");
	...
	class NameValidation {
		...
		void shouldRejectNullName() {
			var request = new GrapeUpsertRequest(null);
		...
		void shouldRejectEmptyName() {
			...
			var request = new GrapeUpsertRequest("");
			var violations = validator.validate(request);
